...
import { getInsurancePlans } from 'apiSdk/insurance-plans';
...
function DashboardPage() {
  ...
  const insurancePlanStat = useSWR<PaginatedInterface<InsurancePlanInterface>>(
    () => `/insurance-plans`,
    () => getInsurancePlans({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: insurancePlanStat?.data?.totalCount,
      isLoading: insurancePlanStat.isLoading,
    },
  ];
