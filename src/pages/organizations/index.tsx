...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'insurance_plan.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('insurance_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'insurance_plan',
          header: 'Insurance Plan',
          accessorKey: 'insurance_plan',
          cell: ({ row: { original: record } }: any) => record?._count?.insurance_plan,
        }
      : null,
