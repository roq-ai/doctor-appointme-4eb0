...
import { getInsurancePlanById } from 'apiSdk/insurance-plans';
import { InsurancePlanInterface } from 'interfaces/insurance-plan';

function InsurancePlanViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('insurance_plan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/insurance-plans/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Plan Name" text={data?.plan_name} />
